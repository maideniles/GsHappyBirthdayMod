package com.mamailes.gabbysgrove.mixin;
...
public class EnsureSafeFlyingVehicleMixin
{
    ...
    private void gabbysgrove_ensureSafeFlyingVehicle(ServerGamePacketListenerImpl impl, boolean flag)
    {
        this.clientVehicleIsFloating = (!(impl.getPlayer().getRootVehicle() instanceof FlyingAnimal a) || !a.isFlying()) && flag;
    }
}