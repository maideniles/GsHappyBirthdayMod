...
public class GGLeafVineDecorator extends TreeDecorator {
    ...
    protected TreeDecoratorType<?> type() {
        return GGTreeDecoratorTypes.DANGLING_DECORATOR.get();
    }
    ...
    private static void addHangingVine(BlockPos blockPos, BooleanProperty p_226042_, Context p_226043_) {
        p_226043_.setBlock(blockPos, Blocks.GLOW_LICHEN.defaultBlockState().setValue(p_226042_, true));
        int i = 4;

        for(BlockPos blockpos1 = blockPos.below(); p_226043_.isAir(blockpos1) && i > 0; --i) {
            p_226043_.setBlock(blockpos1, Blocks.GLOW_LICHEN.defaultBlockState().setValue(p_226042_, true));
