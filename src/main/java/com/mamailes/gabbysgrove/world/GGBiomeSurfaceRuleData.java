...
public class GGBiomeSurfaceRuleData
{
    ...
    public static SurfaceRules.RuleSource makeRules()
    {
        ...
        return SurfaceRules.sequence(
                SurfaceRules.ifTrue(SurfaceRules.isBiome(GGBiomes.HOT_RED), RED_TERRACOTTA),
                SurfaceRules.ifTrue(SurfaceRules.isBiome(GGBiomes.GABBYS_GROVE), GRASS_BLOCK),
